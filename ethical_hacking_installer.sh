...
# Function: Print the original fancy banner
print_banner() {
    clear
    echo -e "${CYAN}"
    echo "╔═══════════════════════════════════════════════════════════╗"
...
# Function: Detect OS (silent version)
detect_os() {
...
# Function: Show main menu (with boxed design)
show_main_menu() {
    while true; do
        echo ""
        echo -e "${CYAN}╔══════════════════════════════════════════════╗${NC}"
...
# Function: Show category menu (with boxed design)
show_category_menu() {
    while true; do
        echo ""
        echo -e "${CYAN}╔══════════════════════════════════════════════╗${NC}"
